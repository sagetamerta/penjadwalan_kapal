...
public class Penjadwalan extends JFrame {
	...
	private String[] header_6 = { "Hari Ke", "00.00", "01.30", "03.00", "04.30", "06.00", "07.30", "09.00", "10.30",
	...
	public Penjadwalan() {
		...
		JLabel lblOptimasiPenjadwalanKapal = new JLabel(
				"OPTIMASI PENJADWALAN KAPAL PENUMPANG MENGGUNAKAN ALGORITMA GENETIKA");
	...
	public void getData() {
		...
		try {
			...
			while (rs.next()) {
				...
				tbmodel_datakapal.addRow(new Object[] { data[i][0], data[i][1], data[i][2] });
				i++;
			}
		} catch (Exception ex) {
			ex.printStackTrace();
	...
	public void tampilJadwal() {
		...
		for (int i = 0; i < 10; i++) {
			tbmodel_jadwal.addRow(
					new Object[] { i + 1, gabungan[indexTerbaik][(i * 16) + 0], gabungan[indexTerbaik][(i * 16) + 1],
							gabungan[indexTerbaik][(i * 16) + 2], gabungan[indexTerbaik][(i * 16) + 3],
							gabungan[indexTerbaik][(i * 16) + 4], gabungan[indexTerbaik][(i * 16) + 5],
							gabungan[indexTerbaik][(i * 16) + 6], gabungan[indexTerbaik][(i * 16) + 7],
							gabungan[indexTerbaik][(i * 16) + 8], gabungan[indexTerbaik][(i * 16) + 9],
							gabungan[indexTerbaik][(i * 16) + 10], gabungan[indexTerbaik][(i * 16) + 11],
							gabungan[indexTerbaik][(i * 16) + 12], gabungan[indexTerbaik][(i * 16) + 13],
